...
- **Review non-convergence** — If several completed review-fix cycles do not reduce repeated package/root-cause clusters, HerdOS creates and dispatches one strategy-level fix issue instead of asking for another `/herd fix`.
