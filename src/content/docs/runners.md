...
`docker-compose.herd.yml` is regenerated by `herd init`. To add project-specific configuration (non-secret build args, extra volumes, environment variables), create a `docker-compose.herd.override.yml`:
